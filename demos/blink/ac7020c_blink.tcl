...
#
# alinx_blink.tcl: Tcl script for re-creating project 'alinx_blink'
#
# Generated by Vivado on Sat Mar 21 18:57:57 CET 2026
...
#
# 1. This project restoration tcl script (alinx_blink.tcl) that was generated.
#
...
set _xil_proj_name_ "alinx_blink"
...
set script_file "alinx_blink.tcl"
...
proc print_help {} {
  ...
  puts "\[--project_dir <dir>\] Create project in the specified directory. Default"
  puts "                       directory is where this script is the current one.\n"
...
set orig_proj_dir "[file normalize "$origin_dir/alinx_blink"]"
...
# Create project
create_project ${_xil_proj_name_} ${project_dir}/${_xil_proj_name_} -part xc7z020clg400-2
...
set_property -name "board_part" -value "en.alinx.com:ac7020c:part0:1.0" -objects $obj
...
set_property -name "platform.board_id" -value "ac7020c" -objects $obj
...
\
  ...
  set_property -dict [list \
    CONFIG.GPIO_BOARD_INTERFACE {led_pl} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports led_pl] [get_bd_intf_pins axi_gpio_0/GPIO]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-69,-66",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 970 -y 230 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 970 -y 260 -defaultsOSRD
preplace port led_pl -pg 1 -lvl 4 -x 970 -y 360 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 220 -y 290 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 840 -y 360 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 580 -y 340 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 220 -y 100 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 410 420 420 720J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 400 410
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 430 430 730
preplace netloc processing_system7_0_DDR 1 1 3 440J 230 NJ 230 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 260 NJ 260 NJ
preplace netloc axi_gpio_0_GPIO 1 3 1 NJ 360
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 440 300n
preplace netloc axi_smc_M00_AXI 1 2 1 N 340
levelinfo -pg 1 0 220 580 840 970
pagesize -pg 1 -db -bbox -sgen 0 0 1080 440
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list block_design.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/alinx_blink/alinx_blink.gen/sources_1/bd/block_design/hdl/block_design_wrapper.v" ]
} else {
